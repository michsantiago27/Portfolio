...
const storage = getStorage(firebaseApp, "gs://autenticacion-ejercicio.appspot.com"); // Esta dirección se obtiene de Firebase>[proyecto]>Storage>Files>[Liga de acceso a la carpeta]
